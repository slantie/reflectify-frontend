        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onChange={(e) =>
                updateFilter("academicYearId", e.target.value || undefined)
              }
            >
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onChange={(e) =>
                updateFilter("semesterId", e.target.value || undefined)
              }
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onChange={(e) =>
                updateFilter("divisionId", e.target.value || undefined)
              }
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onChange={(e) =>
                updateFilter("lectureType", e.target.value || undefined)
              }
            >
