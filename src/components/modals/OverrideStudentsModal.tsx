...
export default function OverrideStudentsModal({
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      showToast.error(
        error.response?.data?.message || "Failed to upload students data",
      );
    } finally {
          ...
          <Card className="p-6">
              ...
              <div className="flex gap-3 items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 dark:text-blue-400 mt-1">
                    This form will be sent only to the uploaded students data.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-6 text-sm text-light-muted-text dark:text-dark-muted-text">
              ...
              <ul className="list-disc list-inside space-y-1 text-xs">
                ...
                <li>
                  <strong>Enrollment</strong> (optional): Student enrollment
                  number
                </li>
                <li>
                  <strong>Batch</strong> (optional): Student batch/group
                </li>
                <li>
                  <strong>Phone</strong> (optional): Phone number
                </li>
                <li>
                  <strong>Department</strong> (optional): Department name
                </li>
                <li>
                  <strong>Semester</strong> (optional): Semester information
                </li>
              </ul>
            </div>
