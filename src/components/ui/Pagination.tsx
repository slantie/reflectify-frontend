...
export const Pagination: React.FC<PaginationProps> = ({
  ...
  const sizeConfig = {
    sm: {
      button:
        "h-8 w-8 text-xs border border-light-secondary dark:border-dark-secondary rounded-sm flex items-center justify-center hover:bg-light-secondary dark:hover:bg-dark-secondary",
      text: "text-xs",
      spacing: "gap-1",
    },
    md: {
      button:
        "h-10 w-10 text-sm border border-light-secondary dark:border-dark-secondary rounded-md flex items-center justify-center hover:bg-light-secondary dark:hover:bg-dark-secondary",
      text: "text-sm",
      spacing: "gap-2",
    },
    lg: {
      button:
        "h-12 w-12 text-base border border-light-secondary dark:border-dark-secondary rounded-lg flex items-center justify-center hover:bg-light-secondary dark:hover:bg-dark-secondary",
      text: "text-base",
      spacing: "gap-3",
    },
  };
