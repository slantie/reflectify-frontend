...
> = {
  top: {
    ...
    arrow:
      "top-full left-1/2 border-l-transparent border-r-transparent border-b-transparent",
    transform: "-translate-x-1/2",
  },
  "top-start": {
    tooltip: "bottom-full left-0 mb-2",
    arrow:
      "top-full left-2 border-l-transparent border-r-transparent border-b-transparent",
    transform: "",
  },
  "top-end": {
    tooltip: "bottom-full right-0 mb-2",
    arrow:
      "top-full right-2 border-l-transparent border-r-transparent border-b-transparent",
    transform: "",
  },
  bottom: {
    tooltip: "top-full left-1/2 mt-2",
    arrow:
      "bottom-full left-1/2 border-l-transparent border-r-transparent border-t-transparent",
    transform: "-translate-x-1/2",
  },
  "bottom-start": {
  ...
  left: {
    ...
    arrow:
      "left-full top-1/2 border-t-transparent border-b-transparent border-r-transparent",
    transform: "-translate-y-1/2",
  },
  "left-start": {
    tooltip: "right-full top-0 mr-2",
    arrow:
      "left-full top-2 border-t-transparent border-b-transparent border-r-transparent",
    transform: "",
  },
  "left-end": {
    tooltip: "right-full bottom-0 mr-2",
    arrow:
      "left-full bottom-2 border-t-transparent border-b-transparent border-r-transparent",
    transform: "",
  },
  right: {
    tooltip: "left-full top-1/2 ml-2",
    arrow:
      "right-full top-1/2 border-t-transparent border-b-transparent border-l-transparent",
    transform: "-translate-y-1/2",
  },
  "right-start": {
    tooltip: "left-full top-0 ml-2",
    arrow:
      "right-full top-2 border-t-transparent border-b-transparent border-l-transparent",
    transform: "",
  },
  "right-end": {
    tooltip: "left-full bottom-0 ml-2",
    arrow:
      "right-full bottom-2 border-t-transparent border-b-transparent border-l-transparent",
    transform: "",
  },
};
