  ...
  const features = [
    {
      ...
      description: "Streamlining feedback collection to enhance teaching quality and student learning outcomes."
    },
    {
      icon: ChartBarIcon,
      title: "Data-Driven Insights",
      description: "Advanced analytics and reporting to help institutions make informed decisions."
    },
    {
      icon: UserGroupIcon,
      title: "Community Focused",
      description: "Connecting students, faculty, and administrators in a unified feedback ecosystem."
    },
    {
      icon: StarIcon,
      title: "Quality Assurance",
      description: "Ensuring consistent and reliable feedback mechanisms across all departments."
    }
  ];
        ...
        <div className="space-y-12">
            ...
            <div className="text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-lg text-blue-800 dark:text-blue-200 max-w-4xl mx-auto leading-relaxed">
                  Reflectify is dedicated to revolutionizing the educational feedback ecosystem by providing 
                  a comprehensive, user-friendly platform that bridges the gap between students, faculty, and 
                  administrators. We believe that effective feedback is the cornerstone of academic excellence 
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Comprehensive tools and features designed to enhance the educational experience
              </p>
            </div>
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                The talented individuals behind Reflectify&apos;s development and success
              </p>
            </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-center">
                      <Image
                        ...
                        onError={(e) => {
                          e.currentTarget.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(member.name)}&background=e5f3ff&color=1e40af&size=96`;
                        }}
                      />
                    </div>
                    <div>
            ...
            <div className="text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-lg text-green-800 dark:text-green-200 max-w-4xl mx-auto leading-relaxed">
                  We envision a future where educational institutions worldwide utilize data-driven 
                  feedback systems to continuously evolve and improve. Through Reflectify, we aim to 
                  create a transparent, efficient, and meaningful dialogue between all stakeholders 
            ...
            <Card className="p-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">Database ORM</div>
                </div>
                <div className="space-y-2">
                  <div className="text-2xl font-bold text-indigo-600">TypeScript</div>
