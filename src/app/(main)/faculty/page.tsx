...
export default function FacultyManagement() {
    ...
    return (
        <div className="p-4 md:p-8 max-w-[1920px] min-h-[48.05rem] mx-auto space-y-6 md:space-y-8 bg-light-background dark:bg-dark-background text-light-text dark:text-dark-text">
            {/* Header Section */}
