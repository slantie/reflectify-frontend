...
"use client"; // Keep this as it uses framer-motion and PublicRoute
...
// Import your PublicRoute component
...
// Your actual home page content component (NOT the default export)
                ...
                >
                    <div className="space-y-8 mt-10 md:mt-20">
                        ...
                        <p className="text-lg md:text-xl text-secondary-dark dark:text-secondary-light">
                            ...
                            continuous improvement with our anonymous feedback
                            platform.
                        </p>
...
export default function HomePublicRoute() {
    return (
