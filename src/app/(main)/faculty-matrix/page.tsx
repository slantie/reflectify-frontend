...
export default function FacultyMatrixPage() {
    ...
    return (
        <div className="min-h-screen bg-light-muted-background dark:bg-dark-background">
            <div className="mx-auto px-4 sm:px-6 py-6 md:py-8">
                            ...
                            transition-all font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                                ...
                                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                                    ...
                                    <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                                        <li>
                                            • Download the reference file to see
                                            the required format
                                        </li>
                                        <li>
                                            • Ensure all faculty and subject
                                            data is uploaded before matrix
                                            upload
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            • Verify department abbreviation
                                            matches your department code
                                        </li>
                                    </ul>
                                </div>
                            </div>
