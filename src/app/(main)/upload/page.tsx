...
export default function UploadPage() {
  ...
  const [activeTab, setActiveTab] = useState<"Faculty Matrix" | "Data Upload">(
    "Faculty Matrix",
  );
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div>
                ...
                <p className="text-base text-light-muted-text dark:text-dark-muted-text flex items-center gap-2 mt-2">
                  <DocumentArrowUpIcon className="h-6 w-6 text-positive-main" />
                  Upload and preview academic data files
                </p>
              </div>
            </div>
          </motion.div>

          <Card className="bg-light-background dark:bg-dark-muted-background border border-light-secondary dark:border-dark-secondary rounded-2xl shadow-sm p-4">
            <Tabs
              value={activeTab}
            ...
            >
              <div className="pb-6 border-b border-light-secondary dark:border-dark-secondary">
                <TabsList className="grid w-full grid-cols-2 gap-4 rounded-xl p-1">
                  <TabsTrigger
                    ...
                    className="flex items-center gap-2 text-md py-2"
                  >
              ...
              <div>
                <TabsContent value="Faculty Matrix" className="space-y-6">
                  <div className="bg-light-background dark:bg-dark-muted-background">
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-400">
                                  Upload faculty teaching assignments and
                                  schedules
                                </p>
                              </div>
                            </div>
                          ...
                          {file && (
                            <div className="flex items-center justify-between rounded-lg">
                              ...
                              <button
                                onClick={() => handleClearFile("facultyMatrix")}
                          ...
                          <div className="flex flex-col sm:flex-row gap-3">
                            <button
                              onClick={() => handlePreview("facultyMatrix")}
                              disabled={!file}
                          ...
                          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                            ...
                            <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                              ...
                              <li>
                                • Select the correct academic year and semester
                              </li>
                              <li>
                                • Verify department abbreviation matches your
                                department code
                              </li>
                            </ul>
                          </div>
                      ...
                      <div className="w-full col-span-2">
                        <DataTable
                          ...
                          showCard={true}
                          showSearch={
                            activeTable?.data && activeTable.data.length > 20
                          }
                          showPagination={
                            activeTable?.data && activeTable.data.length > 25
                          }
                          pageSize={10}
                          maxHeight="770px"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                      {Object.entries(FILE_ROUTES)
                        .filter(
                          ([key]) =>
                            key !== "facultyMatrix" && key !== "studentData",
                    ...
                    <div className="w-full">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                              ...
                              <div className="text-sm text-light-muted-text dark:text-dark-muted-text">
                                <span className="font-semibold text-light-text dark:text-dark-text">
                                  {
                                    Object.keys(displayTable.data[0] || {})
                                      .length
                                  }
                                </span>{" "}
                                columns
                              ...
                              <div className="text-sm text-light-muted-text dark:text-dark-muted-text">
                                <span className="font-semibold text-light-text dark:text-dark-text">
                                  {Math.ceil(displayTable.data.length / 20)}
                                </span>{" "}
                                pages (Page size: 20)
                              </div>
                            </div>
                      ...
                      <DataTable
                        ...
                        showCard={true}
                        showSearch={
                          displayTable?.data && displayTable.data.length > 5
                        }
