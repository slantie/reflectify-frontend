// filepath: c:\Users\Lenovo\Desktop\Reflectify-Frontend\frontend\src\app\page.tsx
// src/app/page.tsx
"use client";
...
import logo from "../../public/Reflectify.svg"; // Adjust path if needed
    ...
    return (
        <div className="min-h-screen bg-light-background dark:bg-dark-background text-light-text dark:text-dark-text flex flex-col">
            ...
            <main
                ...
                className="bg-gradient-to-br from-white/80 to-white dark:from-secondary-darker/80 dark:to-secondary-darker"
            >
                <div
                    suppressHydrationWarning
                    className="mx-auto px-16 py-6 md:py-20 bg-light-background dark:bg-dark-background"
                >
                    <motion.div
                ...
                dark:border-light-primary dark:text-light-primary dark:hover:bg-primary-darker/20 dark:hover:text-primary-light"
                    ...
                    >
                        {[
                            ...
                            <div
                                key={index}
                                className="bg-light-secondary dark:bg-dark-secondary p-6 rounded-xl shadow-md hover:shadow-xl hover:dark:shadow-dark-secondary/20 transform hover:scale-105 transition-transform duration-300"
                            >
...
// The default export wraps the content with PublicRoute
